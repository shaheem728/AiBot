...
export default function LoginPage() {
  ...
  try {
      ...
      if (response.ok) {
          ...
          localStorage.setItem('token',JSON.stringify(resData.tokens));
          setSuccessMsg(true);
          setErrorMsg('');
  ...
  return (
    <section className="px-2 md:px-32 flex flex-col items-center mt-10 my-7 justify-center bg-gray-50">
