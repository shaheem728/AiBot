...
import { refreshToken } from "../redux/slices/userDetailSlice";
        ...
        <div className=" px-5 border rounded-2xl  flex flex-col  w-full">
          {cartItems.length > 0 ? (
            ...
            <div className="text-center my-10">
              ...
              <button
                type="button"
                className="text-white bg-[#050708] hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-6 py-2.5 text-center inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 me-2 mb-2"
                onClick={() => router.back()}
              >
                <svg
                  className="w-6 h-6 me-1 text-white "
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
