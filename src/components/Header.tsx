...
import { Dropdown,Drawer } from "flowbite-react";
...
const Header = () => {
  ...
  return (
    <>
      ...
      <nav className="flex justify-between bg-white border-gray-200">
        <div className="max-w-screen-xl flex flex-wrap space-x-5 gap-16 lg:gap-5 justify-between m-auto p-4">
            ...
            >
              {user == false && (
                <div className="w-28 text-center">
                  <Dropdown.Item onClick={() => router.push("/user/login")}>
                    Login
                  </Dropdown.Item>
                  <hr />
                  <Dropdown.Item onClick={() => router.push("/user/signup")}>
                    SignUp
                  </Dropdown.Item>
                </div>
              )}
              {user == true && (
                <>
                  <div className="hidden md:block">
                    <Dropdown.Item
                      onClick={() => {router.push("/user/profileInfo");handleProfile();}}
                    >
                      Profile
                    </Dropdown.Item>
                  </div>
                  <div className="md:hidden">
                    <Dropdown.Item
                      onClick={() => { router.push("/user/profile/");handleProfile();}}
                    >
                      Profile
                    </Dropdown.Item>
                  </div>
                  <Dropdown.Item
                    onClick={() => router.push("/user/orders_review")}
                  >
                    My Orders
                  </Dropdown.Item>
                  <hr />
