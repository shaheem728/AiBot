      ...
      {errorMsg && (
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-between my-2">
            <span className="font-normal text-gray-500 text-xl">Address</span>
            <span className="text-1xl font-bold">
              {userInfo?.profile.address || ""}
            </span>
          </div>
          <div className="flex justify-between my-2">
            <span className="font-normal text-gray-500 text-xl">Country</span>
            <span className="text-1xl font-bold">
              {shippingAddress.country || ""}
            </span>
          </div>
          <div className="flex justify-between my-2">
            <span className="font-normal text-gray-500 text-xl">State</span>
            <span className="text-1xl font-bold">
              {shippingAddress.state || ""}
            </span>
          </div>
          <div className="flex justify-between my-2">
            <span className="font-normal text-gray-500 text-xl">City</span>
            <span className="text-1xl font-bold">
          ...
          <span className="font-normal text-gray-500 text-xl">Card</span>
          <hr />
