      ...
      <div className="w-full max-w-4xl border rounded-2xl px-6 py-8 bg-white shadow-lg">
        ...
        <form className="space-y-6" action={handleForm}>
          ...
          <div className="flex flex-col">
              <label htmlFor="country" className="text-sm font-semibold text-gray-600 mb-2">
                Country
              </label>
              <input
                type="text"
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col">
              <label htmlFor="Postal Code" className="text-sm font-semibold text-gray-600 mb-2">
              Postal Code
              </label>
              <input
                type="text"
          ...
          <div className="flex justify-between">
                  <button
                    className="bg-black flex justify-center items-center  rounded-full text-white py-4 px-14 my-3"
