          ...
          <button
            ...
            className={`inline-block p-4 ${
              activeTab === "about"
                ...
                : "hover:text-gray-600"
            } rounded-ss-lg hover:bg-gray-100 dark:hover:bg-gray-700`}
        ...
        >
          <div id="accordion-collapse" data-accordion="collapse">
            <h2 id="accordion-collapse-heading-1">
              <button
                type="button"
                className="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500  focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
